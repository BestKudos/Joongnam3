...
@Controller
public class HobbyBoardDeleteController {
	private static final Logger logger = LoggerFactory.getLogger(HobbyBoardDeleteController.class);
	...
	@RequestMapping("hobbyboarddelete.do")
	public ModelAndView board(Locale locale,HttpServletRequest request,HttpServletResponse response) {
		logger.info("Welcome hobbyboarddelete! The client locale is {}.", locale);
		...
		modelAndView.setViewName("hobbyboarddelete");
