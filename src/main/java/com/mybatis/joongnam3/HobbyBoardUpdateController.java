...
@Controller
public class HobbyBoardUpdateController {
	private static final Logger logger = LoggerFactory.getLogger(HobbyBoardUpdateController.class);
	...
	@RequestMapping("hobbyboardupdate.do")
	public ModelAndView hobbyboardupdate(Locale locale,HttpServletRequest request,HttpServletResponse response) {
		logger.info("Welcome hobbyboardupdate! The client locale is {}.", locale);
		...
		modelAndView.setViewName("hobbyboardupdate");
