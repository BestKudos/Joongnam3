...
@Controller
public class InformationBoardUpdateController {
	private static final Logger logger = LoggerFactory.getLogger(InformationBoardUpdateController.class);
	...
	@RequestMapping("informationboardupdate.do")
	public ModelAndView informationboardupdate(Locale locale,HttpServletRequest request,HttpServletResponse response) {
		logger.info("Welcome informationboardupdate! The client locale is {}.", locale);
		...
		modelAndView.setViewName("informationboardupdate");
