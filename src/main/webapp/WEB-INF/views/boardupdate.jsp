...
<body>
<form action="boardlist.do?confirm=2&page=${currentPage }&idx=${currentIdx }&log=${log}&category=${category.category_no}" method="post" name="uform"
		onsubmit="return formchk()" style="margin-top: 5%;">
<table align="center" width="80%" border="1">
	<tr>
		<td>작성자</td>
		<td><input type="hidden" name="m_name" value="${bo.m_name }">${bo.m_name }</td>
		<td>작성일</td>
